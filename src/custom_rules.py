...
Rule 2: Ergonomic Lifting
* Holding the load close to your body at waist height [General Duty Clause, Section 5(a)(1)]
* Never lift a heavy item above shoulder level.
* Never carry a load that obstructs your vision.

Rule 3: Protective Equipment
...
Rule 4: Ladder Use
* Ladders are used only on stable and level surfaces unless they are secured or stabilized to prevent accidental displacement; [29 CFR 1910.23(c)(4)]
...
"""Rule 1: Driving Distraction
* A driver cannot operate a vehicle with an animal on their lap, or while the driver or a passenger is leading an animal, or while an animal is tied to a vehicle. [Road Safety Road Rules 2017 - reg 297] 
* Drivers who hold a full licence in general cannot touch an unmounted portable device, such as a phone, tablet, laptop or any other device while driving. [New Vic Road Rules]
* Anything that distracts the driver should be avoided. [New Vic Road Rules]
* A driver must not operate a fatigue-regulated heavy vehicle on a road while impaired by fatigue. [Heavy Vehicle National Law]

Rule 2: Traffic Rules
* Drivers and riders must give way to anyone on or about to step onto a pedestrian crossing [Road Safety Road Rules 2017 Part 7]
* Drivers and riders must not overtake another vehicle that has stopped at a pedestrian crossing. [Road Safety Road Rules 2017 Part 7]
...
* Pedestrians are not allowed to cause a traffic hazard by moving into the path of a driver. [Road Safety Road Rules 2017 Part 14]

Rule 4: Road Condition
* A person who drives a motor vehicle on a highway must drive in a safe manner having regard to all the relevant factors include the following— [ROAD SAFETY ACT 1986 - SECT 17A]
    ...
    Examples include:
    - Depressions or potholes in the pavement that can cause vehicle damage or accidents.
    - Debris or foreign objects that obstruct or endanger vehicles.
    - Presence of animals on or near roads causing collision risks.
    - Water accumulation causing hydroplaning or road damage.
    - Construction zones, detours, or lane closures posing risks.
    - Environmental conditions reducing visibility or traction.
    - Tree branches or plants obstructing clear sight lines.

Rule 5: Vehicle Load
* The following requirements apply to a vehicle that is carrying a load: [ROAD SAFETY (VEHICLES) REGULATIONS 2021 - REG 285]
    (a) the load must be secured by a means that is appropriate to the vehicle and the nature of the load;
    ...
    (d) the load must be placed and secured on the vehicle in compliance with the performance standards 
""",

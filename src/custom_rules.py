...
* Driving on a one-way service road: A driver on the part of the road that is a service road (except a service road to which a two-way sign applies) must drive in the same direction as a vehicle travelling on the part of the road closest to the service road is required to travel. [ROAD SAFETY ROAD RULES 2017 - REG 136]
